...
Given the raw sequencing files for each experiment, all of the basecalled, modcalled, trimmed, and aligned BAM files used in this study can be exactly recreated using these scripts by adjusting the path variables at the top of the appropriate file.
